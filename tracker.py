# 封装的一个目标追踪器，对检测的车辆进行追踪
import cv2
import torch
import numpy as np

from deep_sort.tools.utils.parser import get_config
from deep_sort.tools.deep_sort import DeepSort

cfg = get_config()
cfg.merge_from_file("D:\speed-detection\deep_sort\configs\deep_sort.yaml")
...
def draw_bboxes(image, bboxes, line_thickness):
    ...
    for (x1, y1, x2, y2, cls_id, pos_id) in bboxes:
        ...
        cv2.putText(image, '{}'.format(cls_id), (c1[0], c1[1] - 2), 0, line_thickness / 3,
