...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data coco128.yaml --weights yolov8s.pt --cache
```
...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data clearml://<your_dataset_id> --weights yolov8s.pt --cache
```
