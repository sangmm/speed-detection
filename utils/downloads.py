...
def safe_download(file, url, url2=None, min_bytes=1E0, error_msg=''):
    ...
    from tools.general import LOGGER
...
def attempt_download(file, repo='ultralytics/yolov5', release='v6.2'):
    ...
    def github_assets(repository, version='latest'):
        # Return GitHub repo tag (i.e. 'v6.2') and assets (i.e. ['yolov8s.pt', 'yolov8m.pt', ...])
        if version != 'latest':
    ...
    if not file.exists():
        ...
        # GitHub assets
        assets = [
            'yolov8n.pt', 'yolov8s.pt', 'yolov8m.pt', 'yolov8l.pt', 'yolov8x.pt', 'yolov5n6.pt', 'yolov5s6.pt',
