...
Usage:
    $ python utils/benchmarks.py --weights yolov8s.pt --img 640
"""
...
import export
import val
from tools import notebook_init
from tools.general import LOGGER, print_args


def run(weights=ROOT / 'yolov8s.pt',  # weights path
