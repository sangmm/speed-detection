...
Usage:
    $ python models/yolo.py --cfg yolov8s.yaml
"""
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg='yolov8s.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        super().__init__()
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x,CBRM,Shuffle_Block,GAMAttention}:
            c1, c2 = ch[f], args[0]
